    ...
    return (
        <div>
            ...
            <div>
                ...
                <input type="text" id="reason" placeholder="Enter reason" value={reason} onChange={(e) => setReason(e.target.value)} required />
            </div>
            <div>
                <label htmlFor="effectDate">Effective Date:</label>
                <input type="date" id="effectDate" value={effectDate} onChange={(e) => setEffectDate(e.target.value)} required />
            </div>
            <div>
                <label htmlFor="registrationDate">Registration Date:</label>
                <input type="date" id="registrationDate" value={registrationDate} onChange={(e) => setRegistrationDate(e.target.value)} required />
            </div>
